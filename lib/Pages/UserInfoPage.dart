      ...
      body: Card(
        ...
        child: Column(
          children: [
            ListTile(
              title: Text(
                '${userInfo.name}', style: TextStyle(fontWeight: FontWeight.w500,),
                ),
            ...
            ListTile(
                          title: Text('${userInfo.email.isEmpty?'Not specified':userInfo.email}',style: TextStyle(fontWeight: FontWeight.w500,),
              ),
